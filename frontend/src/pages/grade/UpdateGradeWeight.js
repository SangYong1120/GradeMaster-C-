...
const UpdateGradeWeight = () => {
    ...
    useEffect(() => {
        if (gradeWeight) {
            const fields = ['courseId', 'itemType', 'weight'];
                                        ...
                                        <Row>
                                            <Col md="6">
                                                <div className='mb-2'>
                                                    <Label>Course</Label>
                                                    <select
                                                        className={classnames('form-control', { 'is-invalid': errors.courseId })}
                                                    ...
                                                    {errors.courseId && <small className="text-danger">Course is required.</small>}
                                                </div>
                                            </Col>
                                            <Col md="6">
                                                <div className='mb-2'>
                                                    ...
                                                    <select
                                                        className={classnames('form-control', { 'is-invalid': errors.itemType })}
                                                    ...
                                                    {errors.itemType && <small className="text-danger">Item type is required.</small>}
                                                </div>
                                            </Col>
                                            <Col md="6">
                                                <div className='mb-2'>

...
const TaskSubmissions = () => {
    ...
    const columns = () => [
        ...
        },
        {
            ...
            selector: (row = {}) => new Date(row.submissionDate).toLocaleDateString() || '',
            sortable: true
        },
        {
            name: 'Actions',
    ...
    return (
        <div className="container main-content">
            ...
            <Row className="my-3">
                <Col>
                    <a href="/taskSubmissions/create-taskSubmission" className="btn btn-outline-primary">Create Task Submission</a>
                </Col>
            </Row>
            <Card>
                <CardBody>
